    ...
    <v-dialog v-model="dialog" persistent max-width="1000px">
      <v-card class="mx-auto">
                ...
                <v-row>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        <v-card-text>
                          A spectrum is created when you pass
                          light from a source through a spectrograph, (Testing!!!!!!!!!!!) which
                          separates the light into its different colors (like a
                          rainbow) and measures how much light there is at each
                          color (or wavelength).
                        </v-card-text>
                      </v-card>
                      <br />
        ...
        <v-card-actions class="justify-space-between">
          ...
          <v-spacer></v-spacer>
          <v-btn :disabled="step === 6" color="accent" text @click="step++">
            {{ step < 6 ? "next" : "" }}
          </v-btn>
          <v-btn
            :disabled="step < 6"
