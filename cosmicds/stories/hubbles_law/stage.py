...
from cosmicds.stories.hubbles_law.data_management import MEAS_TO_STATE, UNITS_TO_STATE
...
class HubbleStage(Stage):
    ...
    def _prepare_measurement(self, measurement):
        prepared = { HubbleStage._map_key(k) : measurement.get(k, None) for k in MEAS_TO_STATE.keys() }
